  ...
  Future<void> fetchChartData(String symbol) async {
    ...
    if (response.statusCode == 200) {
      ...
      final List<dynamic> opens =
          responseData['chart']['result'][0]['indicators']['quote'][0]['open'];
      final List<dynamic> closes =
          responseData['chart']['result'][0]['indicators']['quote'][0]['close'];
      final List<dynamic> highs =
          responseData['chart']['result'][0]['indicators']['quote'][0]['high'];
      final List<dynamic> lows =
          responseData['chart']['result'][0]['indicators']['quote'][0]['low'];
