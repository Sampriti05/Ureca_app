...
//initState when stateful widget called in a widget tree for the first time 
  ...
  Widget build(BuildContext context) {
    ...
    double myHeight; myHeight = MediaQuery.of(context).size.height;
    double myWidth; myWidth = MediaQuery.of(context).size.width;
