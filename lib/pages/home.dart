  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Container(
            ...
            decoration:
                const BoxDecoration(color: Color.fromARGB(255, 0, 122, 255)),
            child: Column(
                      ...
                      child: Container(
                          ...
                          child: Column(children: <Widget>[
                            ...
                            Container(
                              ...
                              height: 220,
                              child: Image.asset(
                                  'assets/MyBalanceholder.png'), //placeholder for my activity, sync after backend is completed
                            )
                          ]))),
                  Expanded(
                      child: Container(
      ...
      children: [
        Container(
          height: MediaQuery.of(context).size.height /
              3.5, // Adjust the height as needed
              ...
              return FutureBuilder(
                ...
                builder: (context, snapshot) {
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    ...
                    final regularMarketPrice = double.parse(stockData['chart']
