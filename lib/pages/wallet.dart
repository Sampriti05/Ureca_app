...
//this site is a placeholder for past transactions, to be done after backend 
...
class _BottomSelectionWidgetState extends State<BottomSelectionWidget> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Wallet"),backgroundColor: const Color.fromARGB(255, 0, 122, 255),
      actions: [
